/* Cinema Index page: a quiet, high-contrast editorial recovery screen for DAM navigation misses. */
  ...
  return (
    <div data-page="404" className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#010101] px-6 py-10 text-center">
      <div
        ...
        style={{
          backgroundImage:
            "repeating-linear-gradient(0deg, transparent 0px, transparent 3px, rgba(255,255,255,0.035) 4px)",
        }}
      />
