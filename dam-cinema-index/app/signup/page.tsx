  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full bg-card/60 backdrop-blur-xl border border-border/40 rounded-2xl p-8 text-center shadow-2xl">
        ...
        <h1 className="text-2xl font-bold tracking-tight mb-2">Streaming is 100% Free</h1>
        <p className="text-muted-foreground text-sm mb-6 leading-relaxed">
          No signup or registration is required. All features including Watchlist, Reels, Mood Finder, Match Night, and Live TV are immediately unlocked.
        </p>
